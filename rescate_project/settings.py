"""
Django settings for rescate_project project.
...
SECRET_KEY = '^9$3l7ny@-@*(@2pu@*-oqqc+r53=*@!yw35=(4&l13aa=&x&*'
...
ROOT_URLCONF = 'rescate_project.urls'
...
WSGI_APPLICATION = 'rescate_project.wsgi.application'
